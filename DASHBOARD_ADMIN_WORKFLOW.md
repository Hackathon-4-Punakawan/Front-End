...
### 5. Manajemen DPL & Mitra (Create Account, Plotting DPL & Auto Send Email)
- **Penetapan / Plotting DPL**: `POST /api/v1/admin/plotting-dpl` (Body: `{ nim, nidn_dpl, sk_dpl_url? }`)
...
- **Edit Mitra**: `PUT /api/v1/admin/mitra/:id`
