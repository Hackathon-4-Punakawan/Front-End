...
const KaprodiDashboard = () => {
  ...
  const [selectedLogbookMhs, setSelectedLogbookMhs] = useState(null);
      ...
      <div className="main-viewport">
        ...
        {activeNavTab === 'dosen' && (() => {
          const defaultDosenList = [
            { nidn: '0522108201', nama: 'Andi Sunyoto, M.Kom.', email: 'andi.sunyoto@amikom.ac.id', bidang_keahlian: 'Cloud Infrastructure & Computer Network', total_mahasiswa_bimbingan: 3, kuota_max: 5, selesai_evaluasi: 2, menunggu_review: 1, is_active: true },
            { nidn: '0515088502', nama: 'Bambang Kurniawan, M.Eng', email: 'bambang.k@amikom.ac.id', bidang_keahlian: 'Artificial Intelligence & Data Science', total_mahasiswa_bimbingan: 4, kuota_max: 6, selesai_evaluasi: 3, menunggu_review: 1, is_active: true },
            ...
            { nidn: '0512038901', nama: 'Dr. Indah Susanti, M.Kom', email: 'indah.susanti@amikom.ac.id', bidang_keahlian: 'Software Engineering & Web Dev', total_mahasiswa_bimbingan: 5, kuota_max: 5, selesai_evaluasi: 4, menunggu_review: 1, is_active: true },
            { nidn: '0509077801', nama: 'Drs. Kusrini, M.Kom.', email: 'kusrini@amikom.ac.id', bidang_keahlian: 'Business Intelligence & Data Mining', total_mahasiswa_bimbingan: 1, kuota_max: 5, selesai_evaluasi: 1, menunggu_review: 0, is_active: true },
            { nidn: '0511048102', nama: 'Ir. Amiruddin, M.T.', email: 'amiruddin@amikom.ac.id', bidang_keahlian: 'Enterprise Architecture & Governance', total_mahasiswa_bimbingan: 4, kuota_max: 7, selesai_evaluasi: 2, menunggu_review: 2, is_active: true },
            { nidn: '0528098301', nama: 'Niken Hendrakusma, M.Kom', email: 'niken.h@amikom.ac.id', bidang_keahlian: 'UI/UX Design & Human Computer Interaction', total_mahasiswa_bimbingan: 2, kuota_max: 5, selesai_evaluasi: 2, menunggu_review: 0, is_active: true },
            { nidn: '0503027902', nama: 'Romi Satria Wahono, Ph.D.', email: 'romi.wahono@amikom.ac.id', bidang_keahlian: 'Machine Learning & Software Metrics', total_mahasiswa_bimbingan: 6, kuota_max: 8, selesai_evaluasi: 5, menunggu_review: 1, is_active: true },
            { nidn: '0514068703', nama: 'Fajar Masya, M.T.', email: 'fajar.masya@amikom.ac.id', bidang_keahlian: 'Internet of Things & Embedded Systems', total_mahasiswa_bimbingan: 3, kuota_max: 5, selesai_evaluasi: 1, menunggu_review: 2, is_active: true },
            { nidn: '0519118401', nama: 'Widodo, M.Kom', email: 'widodo@amikom.ac.id', bidang_keahlian: 'Database Systems & Big Data Architecture', total_mahasiswa_bimbingan: 2, kuota_max: 5, selesai_evaluasi: 2, menunggu_review: 0, is_active: true },
            { nidn: '0525128802', nama: 'Yuli Astuti, M.Kom', email: 'yuli.astuti@amikom.ac.id', bidang_keahlian: 'Game Development & Interactive Media', total_mahasiswa_bimbingan: 1, kuota_max: 5, selesai_evaluasi: 0, menunggu_review: 1, is_active: true }
          ];
